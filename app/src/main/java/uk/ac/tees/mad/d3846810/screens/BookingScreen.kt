...
import uk.ac.tees.mad.d3846810.screens.listitems.BookingItem
import uk.ac.tees.mad.d3846810.screens.widgets.CustomToolbar

@Composable
fun BookingScreen(
    bookingList: ArrayList<BookingModel> = arrayListOf(),
    productList: ArrayList<ProductModel> = arrayListOf(),
    loadingText: String,
    onBackPressed: () -> Unit,
    ...
    ConstraintLayout(
        ...
        CustomToolbar(title = "Your Bookings", backButtonIcon = R.drawable.ic_arrow, modifier = Modifier.constrainAs(constraintLayout) {
...
fun getProductData(productId: String, productList: ArrayList<ProductModel>): ProductModel? {
